...
for (i = 0; i <= 23; i++)
{
 ...
 menu(datos, mes,k,res_sum2021,res_sum2022);
...
printf(" En 2021 se genero una media de %.2f GWh\n", media_meses2021);
printf(" En 2022 se genero una media de %.2f GWh\n", media_meses2022);
}
void media_generacion_tipos(Energia mes[], float res_sum2021[], float res_sum2022[])
{
  int i, j;
...
printf("Las energia renovables son: La hidraulica, hidroelectrica, eolica, solar fotovoltaica, solar termica, otras renovables y residuos renovables\n\n");
...
{
FILE *pfbal;
pfbal = fopen("balance-electrico_01-2021_12-2022.csv", "r");
...
{
FILE *pfpre;
pfpre = fopen("componentes-precio-energia-cierre-desglose-nuevo_01-2021_12-2022.csv", "r");
...
printf("El precio de la energia consiste del precio del mercado diario mas los servicies de ajuste:\n\n");
...
printf("\n\nEn el anio 20222 el precio promedio de la energia cada mes fue (euros/MWh):\n\n");
...
case 1:
    printf(" \nDATOS REALES \n\n");
    printf(" 1. Datos de 2021/23\n 2. Precio de la energia\n 3. Balance de energia\n ");
    do{
        printf("\n Elige un dato:\n");
        scanf("%i",&elegir);}while(elegir<1||elegir>3);
    switch(elegir){
    case 1:
...
printf(" \nOPERACIONES MATEMATICAS \n\n");
    printf(" 1. Porcentaje total de mes sobre anio\n 2. Porcentaje tipo de energia sobre su total en el anio\n 3. Porcentaje tipo de energia sobre mes\n 4. Media al mes\n 5. Media de cada tecnologia\n 6. Maximo\n 7. Minimo\n ");
    do{
        printf("\n Elige un dato:\n");
        scanf("%i",&elegir);}while(elegir<1||elegir>7);
    switch(elegir){
    case 1:
